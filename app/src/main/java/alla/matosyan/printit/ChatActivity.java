...
public class ChatActivity extends AppCompatActivity {
    ...
    private void callGeminiAPI(String userQuestion) {
        String apiKey = "AIzaSyB82d4yeUHNsr06fUZTmFvfDSqWbWjO_Y8";
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(() -> addAIMessage("Internet Blocked: " + e.getMessage()));
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        runOnUiThread(() -> addAIMessage("Parsing Error. Google sent this instead: " + responseData));
                    }
                } else {
                    runOnUiThread(() -> addAIMessage("Google API Error (Code " + response.code() + "): " + responseData));
                }
            }
        });
    }
